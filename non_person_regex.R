...
non_person_regex <- paste0('(?i)',
                           paste0(c('(\\bac(adem(y|ics?)|oustics?|res?|quisitions?)\\b)',
                                    '(\\bad(ministrations?|v(ent(ist|ures?)|is(ers?|ors?|ing)))\\b)',
                                    ...
                                    '(\\bpr(e(mier|s(byterian|ervation)|\\-?schools?)|i(me|nt(ing|ers?)|sons?)|o(ductions?|(fessional)?s?|grams?|pert(ies|y)))\\b)',
                                    '(\\bpublic(i(sts?|ty))?\\b)',
